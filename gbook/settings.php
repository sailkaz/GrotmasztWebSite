...
$settings['apass'] = 'adminadmin';

// Website title
$settings['website_title'] = "Szkoła Żeglarstwa Grotmaszt";

// Website URL
$settings['website_url'] = 'https://grotmaszt.pl/';

// Guestbook title
$settings['gbook_title'] = "Księga Gości";

// Your e-mail address.
$settings['admin_email'] = 'biuro@grotmaszt.pl';


// URL of the gbook.php file.
$settings['gbook_url'] = 'https://grotmaszt.pl/gbook/gbook.php';
